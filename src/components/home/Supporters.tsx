...
export default function Supporters() {
  return (
    <section className="p-10 text-center bg-primary-0">
      <div className="container mx-auto">
        ...
        <div className="flex py-6">
          <div className="bg-secondary px-6 py-5 max-w-full mx-auto w-72 border border-indigo-500 border-opacity-25 rounded-lg select-none overflow-hidden space-y-1">
            Henk Tetteroo
          </div>
        </div>
        <p>
