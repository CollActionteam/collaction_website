    ...
    <>
      ...
      <main className="bg-secondary p-5 pt-10 md:pt-11">
        ...
        'mb-12',
          ...
          <Image src={donateImg} alt="collaction team members standing" layout="responsive" />
          <div className="absolute bottom-22">
            <h3 className="mb-6 text-secondary">Become a supporter</h3>
            <p className="text-secondary">Help us on our mission to make doing good fun & easy</p>
          </div>
        </div>
